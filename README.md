...
* I will not be responsible for anything(include your switch getting ban from Nintendo) if you use [the fork](https://github.com/yanisdreemurr/ShallowSea-Online-Fork)
